document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateTitle() {
    const title = document.querySelector(
      ".game-selector__modal__header__title"
    );
  ...
  const sliderDesktopTooltip = document.querySelector(
    ".slider-desktop__tooltip"
  );
  ...
  mobileSteps.forEach((step, index) => {
    step.addEventListener("click", () => {
      ...
      const mobileFill = document.querySelector(
        ".slider-mobile__stepper__fill"
      );
      if (mobileFill) {
